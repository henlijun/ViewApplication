 ...
 * resource
 * 度量自己
 * todo 字样、文字的高度（汉字，数字、字母等、字间距度量
 * todo 点击事件优化
 *
 */
public class LConfView6 extends View implements View.OnClickListener {
    ...
    public LConfView6(Context context) {
        this(context, null);
    }

    public LConfView6(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LConfView6(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }
    public LConfView6(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
