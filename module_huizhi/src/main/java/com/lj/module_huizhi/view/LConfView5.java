 ...
 *todo 点击事件优化
 */
public class LConfView5 extends View implements View.OnClickListener {
    ...
    public LConfView5(Context context) {
        this(context, null);
    }

    public LConfView5(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LConfView5(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }
    public LConfView5(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
